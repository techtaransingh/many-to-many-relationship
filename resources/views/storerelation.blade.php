...
<html lang="en">
  <head>
    ...
    <title>Store Relation Page</title>
  </head>
...
<!-- <a href="" class="btn btn-warning">LIST</a> -->
  ...
  <div class="panel-heading"><h3 class="text-left">Store Relation Page</h3></div>
  <div class="panel-body">
<form action ="/store/addrelation" method = "POST">

<div class="form-group">
    <label for="exampleInputEmail1">Store Name</label>
    <input type="text" class="form-control"  name="store_name" id="exampleInputEmail1" aria-describedby="emailHelp" >
     </div>
